...
export const setUsers_ActionCreater = (users) => ({ type: SET_USERS, users });
export const followUser_ActionCreater = (userId) => ({ type: FOLLOW_USER, userId });
export const unfollowUser_ActionCreater = (userId) => ({ type: UNFOLLOW_USER, userId });
